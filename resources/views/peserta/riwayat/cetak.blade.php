    ...
    <div class="bg-white w-full max-w-4xl p-12 shadow-2xl print-shadow-none relative border border-gray-200 overflow-hidden">
            ...
            <table class="w-full text-left text-sm mb-6">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 font-bold">:</td>
                        <td class="py-2 font-medium text-gray-700">Pendaftaran & Biaya Pelatihan <span class="font-bold text-[#de5e2e]">{{ $pendaftaran->kelas->programPelatihan->nama_program }}</span> - Kelas {{ $pendaftaran->kelas->nama_kelas }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="py-2 font-black text-blue-700 uppercase tracking-wider">
                            {{ $pendaftaran->metode_pembayaran ?? 'Manual / Transfer' }}
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="relative z-10 flex justify-between mt-16 pt-8">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600 mb-16">Diterbitkan Oleh,</p>
                <div class="border-b border-gray-400 w-48 mx-auto mb-2"></div>
                <p class="font-bold text-gray-800 text-sm">Bagian Keuangan / Admin</p>
                <p class="text-xs text-gray-500">{{ $nama1 }} {{ $nama2 }}</p>
            </div>
        </div>
    </div>
</body>
