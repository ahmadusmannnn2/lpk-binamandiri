            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse($kelas as $item)
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-lg transition duration-300 hover:border-oranye flex flex-col h-full group">
                        ...
                        <a href="{{ route('instruktur.jadwal.show', $item->id) }}" class="flex items-center justify-center gap-2 bg-hitam text-white px-4 py-3 rounded-xl hover:bg-oranye transition w-full font-bold text-sm shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
