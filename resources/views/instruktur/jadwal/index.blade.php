                ...
                @forelse($kelas as $item)
                    <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-lg transition duration-300 hover:border-oranye flex flex-col h-full group">
                        ...
                        <div class="grid grid-cols-3 gap-2 w-full mt-2">
                            <a href="{{ route('instruktur.materi.index', $item->id) }}" class="flex flex-col items-center justify-center gap-1 bg-gray-50 border border-gray-200 text-gray-700 py-2.5 rounded-xl hover:bg-hitam hover:text-white transition font-bold text-[10px] sm:text-xs shadow-sm hover:shadow-md">
