                            ...
                            <div class="space-y-4">
                                ...
                                <div class="bg-blue-50 p-4 rounded-lg border border-blue-100">
                                    ...
                                    <p class="text-[10px] text-blue-600 mt-2 font-bold leading-tight">
                                        ℹ️ Jika tanggal mulai diubah, tanggal selesai akan dihitung ulang secara otomatis. (Tanggal Selesai saat ini: {{ \Carbon\Carbon::parse($kelas->tanggal_selesai)->format('d-m-Y') }})
                                    </p>
                                </div>
