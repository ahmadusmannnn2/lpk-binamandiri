                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-5 bg-orange-50 p-6 rounded-2xl border border-orange-100 shadow-sm relative overflow-hidden">
                                ...
                                <div class="relative z-10">
                                    ...
                                    <x-text-input id="spesialisasi_las" class="block mt-1 w-full focus:border-oranye focus:ring-oranye rounded-xl transition shadow-sm border-white" type="text" name="spesialisasi_las" value="{{ old('spesialisasi_las', $instruktur->spesialisasi_las) }}" />
                                </div>
                                <div class="relative z-10">
