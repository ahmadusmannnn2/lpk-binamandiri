                ...
                <div class="p-8 text-gray-900">
                    <form action="{{ route('admin.program.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="nama_program" class="block mt-1 w-full focus:border-oranye focus:ring-oranye rounded-xl" type="text" name="nama_program" :value="old('nama_program')" required autofocus />
                        ...
                        <div class="bg-orange-50 p-5 rounded-xl border border-orange-100">
                            ...
                            <x-text-input id="parameter_penilaian" class="block mt-2 w-full focus:border-oranye focus:ring-oranye rounded-xl border-orange-200" type="text" name="parameter_penilaian" :value="old('parameter_penilaian')" placeholder="Contoh: 1F, 2F, 3F, 1G, Teori Bahasa Korea" required />
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" name="deskripsi" rows="4" class="block mt-1 w-full border-gray-300 rounded-xl shadow-sm focus:border-oranye focus:ring-oranye">{{ old('deskripsi') }}</textarea>
