                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.laporan.excel', ['kelas_id' => request('kelas_id'), 'status_kelulusan' => request('status_kelulusan')]) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded font-bold shadow transition transform hover:-translate-y-1 flex items-center gap-2 text-sm">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                                Export Excel
                            </a>

                            <a href="{{ route('admin.laporan.cetak', ['kelas_id' => request('kelas_id'), 'status_kelulusan' => request('status_kelulusan')]) }}" target="_blank" class="bg-oranye hover:bg-[#c24b22] text-white px-4 py-2 rounded font-bold shadow transition transform hover:-translate-y-1 flex items-center gap-2 text-sm">
